...
8. **Mapa de Visibilidade** - Gera um mapa de visibilidade com base num ponto escolhido pelo o usuário conforme o Modelo Digital de Elevação escolhido e altura do observador.
...
10. **Grid (grade) de coordenadas da carta** - Gera moldura sistemática relacionada à camada de polígono selecionada baseada na escala selecionada (sistema de referência da moldura igual ao da camada de entrada)
...
14. **Download de Cartas do BDGEx** - Ao clicar em uma região da tela que esteja dentro do Brasil aparecerá qual carta engloba aquela região, nas diversas escalas, sendo possível baixar as cartas na região escolhida.
